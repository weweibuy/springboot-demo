package org.example.springbootdemo.model.midexample;
...
public class VipUserExample {
    ...
    public VipUserExample orderBy(String orderByClause) {
        this.setOrderByClause(orderByClause);
        return this;
    }

    public VipUserExample orderBy(String ... orderByClauses) {
    ...
    public static Criteria newAndCreateCriteria() {
        VipUserExample example = new VipUserExample();
        return example.createCriteria();
    }

    public VipUserExample when(boolean condition, IExampleWhen then) {
        if (condition) {
            then.example(this);
        }
        return this;
    ...
    public VipUserExample when(boolean condition, IExampleWhen then, IExampleWhen otherwise) {
        if (condition) {
            then.example(this);
        } else {
    ...
    public VipUserExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public VipUserExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public VipUserExample page(Integer page, Integer pageSize) {
    ...
    public static class Criteria extends GeneratedCriteria {
        ...
        protected Criteria(VipUserExample example) {
            super();
            this.example = example;
        }

        public VipUserExample example() {
            return this.example;
        }
    ...
    public interface IExampleWhen {
        void example(org.example.springbootdemo.model.midexample.VipUserExample example);
    }
}